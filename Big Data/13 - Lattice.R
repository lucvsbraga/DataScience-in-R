...
# Na criação de gráficos, condições e agrupamentos são 2 conceitos importantes, que nos permitem compreender facilmente
# os dados que temos em mãos. O conceito por trás do lattice é agrupar os dados e criar visualizações de forma que fique
