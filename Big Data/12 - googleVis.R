...
# Baseado no GOogle Chart (visualização de dados na web), googlevis é um pacote que fornece interface entre R e o Google Charts.
# Utiliza javaScript e arquivos JSON. Os dados são transformados em formato JSON.
# O resultado é gerado em HTML5 ou Flash.
# Pode-se criar os mais variados tipos de frágicos e mapas. Inclusive Google Maps.
