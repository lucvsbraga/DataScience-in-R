...
# *** ATENÇÃO ***
# As funçoes da família apply aplicam uma função a cada elemento do objeto
...
# O resultado da função do.call() pode ser obtide de outra forma
# Pacote plyr
...
frase <- "Muitas vezes temos que repetir algo diversas e essas diversas vezes parecem algo estranho."
