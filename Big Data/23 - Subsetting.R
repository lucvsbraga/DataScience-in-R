...
# Muitas das técnicas abaixo podem ser realizadas com a aplicação subset(), merge(), plyr::arrange()
# Mas conhecer estas notações é fundamental para compreender como gerar subconjuntos de dados
