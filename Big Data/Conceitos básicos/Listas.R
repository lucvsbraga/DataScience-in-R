#Listas são generalizações de vetores, representam uma coleção de objetos. Essa é a estrutura mais generalista da linguagem R.
...
#Podemos extrair o elmento específico dentro de cada nível da lista
lista1$caracteres[2]
