...
# %y: ano em 2 dígitos (92)
# %Y: ano em 4 dígitos (1992)
...
# Operações com Datas
dataHoje <- as.Date("2016-06-25", format = "%Y-%m-%d")
dataHoje
dataHoje + 1
...
dataHoje - as.Date(my_time)
dataHoje - my_time

# Convertendo Daa em formato específico
dts = c(112705601, 1104295502, 1129233601, 1113547501, 1119826801)
mydates = dts
