...
# Gráfico de canclestick da Petrobras
candleChart(PETR4.SA)

# Plot de fechamento
plot(PETR4.SA.Close, main = "Fechamento Diário das Ações Petrobras", col = "red",
     xlab = "Data", ylab = "Preço", major.ticks = 'month',
     minor.ticks = FALSE)

# Adicionado as bandas de bollinger ao gráfico, com média de 20 períodos e 2 desvios
# Bollinger Band
# Como o desvio padrão à uma medida de volatilidade, 
