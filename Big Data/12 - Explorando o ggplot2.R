...
# Outro aspecto que pode ser maepado nesse gráfico é a cor dos pontos
...
# Os geoms definem qual forma geométrica será utilizada para a visualização dos dados no gráficoo. 
...
ggplot(mtcars, aes(x = mpg)) + geom_histogram() + xlab("Milhas por galÃ£o") + ylab("FrequÃªncia") +
  xlim(c(0, 40)) +
  ylim(c(0,8))
